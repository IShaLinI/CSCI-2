...
int main(){
    ...
    for(int i = 0; i < 100; i++) {
        int temp = rand() % 100;
        if(searchListLinear(list, temp) == -1){
            list.push_back(temp);
        }
        else{
            i--;
    ...
    while(true){
        ...
        int index1 = searchListLinear(list, target);
        int index2 = searchListBinary(list, target);
        ...
        if(index1 == -1){
            ...
            cout << "The number was found at index " << index1 << " using linear search." << endl;
        }
        ...
        if(index2 == -1){
            ...
            cout << "The number was found at index " << index2 << " using binary search." << endl;
        }
